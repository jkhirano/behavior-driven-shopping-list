...
describe('Render Method', function() {
  ...
  it('Render method will construct and return an HTML formatted string', function() {
    expect(foo.render()).is.equal(`<ul><li class="completed_false"><span>Beer</span><span>Refreshing Beverage.</span></li><ul>`);
  });

  it(`Render method should return "completed_true" if isDone is true`, function() {
    foo.check();
    expect(foo.render()).is.equal(`<ul><li class="completed_true"><span>Beer</span><span>Refreshing Beverage.</span></li><ul>`);
  });
});